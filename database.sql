...
CREATE TABLE Projets (
    ...
    definition_du_marche TEXT NOT NULL,
    analyse_de_la_demande TEXT NOT NULL,
    analyse_de_la_concurrence TEXT NOT NULL,

    postuleurs_a_l_annonce INT NOT NULL,
...
CREATE TABLE Competences (
    nom PRIMARY KEY VARCHAR(100) NOT NULL,

<div class="navbar-container">
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li><a href="/Start-Hut/src/views/annonces/annonces.php">Rejoindre un projet</a></li>
        ...
        <div class="auth-buttons"> 
            ...
            <?php else : ?>                                 <!-- Sinon -->
                ...
                <a href="/Start-Hut/src/views/projet/espace-projet.php" class="signup">Mes annonces</a>
            <?php endif; ?>
        </div>
    </nav>
